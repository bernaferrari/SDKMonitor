...
internal val filledTrendingUp: ImageVector
  get() {
    if (_filledTrendingUp != null) {
      return _filledTrendingUp!!
    }
    _filledTrendingUp =
      ImageVector.Builder(
          name = "trending_up",
...
internal var _filledTrendingUp: ImageVector? = null

@Suppress("CheckReturnValue")
internal val outlinedTrendingUp: ImageVector
  get() {
    if (_outlinedTrendingUp != null) {
      return _outlinedTrendingUp!!
    }
    _outlinedTrendingUp =
      ImageVector.Builder(
          name = "trending_up",
...
internal var _outlinedTrendingUp: ImageVector? = null
