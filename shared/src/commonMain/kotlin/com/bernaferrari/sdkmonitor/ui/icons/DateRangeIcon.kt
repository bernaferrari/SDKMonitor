...
internal val filledDateRange: ImageVector
  get() {
    if (_filledDateRange != null) {
      return _filledDateRange!!
    }
    _filledDateRange =
      ImageVector.Builder(
          name = "date_range",
...
internal var _filledDateRange: ImageVector? = null

@Suppress("CheckReturnValue")
internal val outlinedDateRange: ImageVector
  get() {
    if (_outlinedDateRange != null) {
      return _outlinedDateRange!!
    }
    _outlinedDateRange =
      ImageVector.Builder(
          name = "date_range",
...
internal var _outlinedDateRange: ImageVector? = null
