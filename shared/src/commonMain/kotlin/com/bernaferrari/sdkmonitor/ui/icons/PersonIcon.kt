...
internal val filledPerson: ImageVector
  get() {
    if (_filledPerson != null) {
      return _filledPerson!!
    }
    _filledPerson =
      ImageVector.Builder(
          name = "person",
...
internal var _filledPerson: ImageVector? = null

@Suppress("CheckReturnValue")
internal val outlinedPerson: ImageVector
  get() {
    if (_outlinedPerson != null) {
      return _outlinedPerson!!
    }
    _outlinedPerson =
      ImageVector.Builder(
          name = "person",
...
internal var _outlinedPerson: ImageVector? = null
